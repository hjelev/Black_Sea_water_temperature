...
const I18N = {
  "en": {
    ...
    "dash_stats_title": "Sea water temperature in {location} on {date} — last 5 years",
  ...
  "bg": {
    ...
    "dash_stats_title": "Температура на морската вода в {location} на {date} — последните 5 години",
